                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex shrink-0 items-center gap-2 ps-2">
                        ...
                        <button
                          ...
                          className="flex h-6 w-6 items-center justify-center rounded-lg text-sm font-bold text-muted hover:text-ink"
                          aria-label="remove"
                        >
                          ×
                        </button>
                    ...
                    {persistent && (
                      <div className="mt-2 flex items-center gap-2">
                        <button
                          ...
                          className="flex h-6 w-6 items-center justify-center rounded-lg border text-xs font-bold text-ink disabled:opacity-30"
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full rounded-lg bg-teal-2 py-3 text-sm font-bold text-navy disabled:opacity-40"
              >
                {t.addTool}
              </button>
          ...
          {persistent ? (
            ...
            <>
              ...
              <button
                type="button"
                onClick={finish}
                className="shrink-0 rounded-lg bg-teal-2 px-6 py-3 text-sm font-bold text-navy"
              >
                {t.next}
              </button>
            </>
