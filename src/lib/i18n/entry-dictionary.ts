...
export const entryDictionary = {
  en: {
    ...
    hero: {
      ...
      titleLine1Before: "Digital transformation isn't about ",
      titleLine1Highlight: "adding more tools",
      titleLine1After: ".",
      titleLine2Before: "It's about making the ones you already have ",
      titleLine2Highlight: "actually work together",
      titleLine2After: ".",
      subtitle: "GapLens shows you exactly where the disconnect is.",
  ...
  ar: {
    ...
    hero: {
      ...
      titleLine1Before: "التحول الرقمي لا يعني ",
      titleLine1Highlight: "إضافة المزيد من الأدوات",
      titleLine1After: ".",
      titleLine2Before: "بل يعني جعل الأدوات التي تملكها ",
      titleLine2Highlight: "فعلاً تعمل معًا",
      titleLine2After: ".",
      subtitle: "GapLens يُظهر لك بالضبط أين يكمن الانقطاع.",
