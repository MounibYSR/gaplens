...
export const entryDictionary = {
  en: {
    ...
    hero: {
      ...
      titleLine1: "Digital transformation isn't about adding more tools.",
      titleLine2: "It's about making the ones you already have actually work together.",
  ...
  ar: {
    ...
    hero: {
      ...
      titleLine1: "التحول الرقمي لا يعني إضافة المزيد من الأدوات.",
      titleLine2: "بل يعني جعل الأدوات التي تملكها فعلاً تعمل معًا.",
